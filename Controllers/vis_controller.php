<?php
  ...
  */
  ...
  function vis_controller()
  {
    ...
    if ($action == 'highstacked' && $session['read'])
    {
      $output['content'] = view("vis/highstacked.php", array());
    }
    
    if ($action == 'highlive' && $session['read'])
    {
      $output['content'] = view("vis/highlive.php", array());
    }
